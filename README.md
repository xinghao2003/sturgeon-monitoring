...
Download the Sturgeon dataset from Roboflow:

1. Visit: https://universe.roboflow.com/sturgeon-e19fo/sturgeon-bcifa
2. Click **"Download Dataset"**
3. Select **YOLO v11** format (instance segmentation variant)
4. Extract to your workspace (e.g., `dataset/`)

The dataset contains 500 annotated sturgeon images in YOLO instance segmentation format.
...
```
dataset/
├── data.yaml          # Dataset configuration (auto-generated by Roboflow)
├── images/
│   ├── train/
│   ├── val/
│   └── test/
